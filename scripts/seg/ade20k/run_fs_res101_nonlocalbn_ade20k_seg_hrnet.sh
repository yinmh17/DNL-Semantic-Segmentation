...
DATA_DIR="/data/home/v-miyin/ADE_train"

BACKBONE="hrnet"
MODEL_NAME="nonlocalbn_hrnet"
CHECKPOINTS_NAME="fs_res101_nonlocal_ade20k_seg"$2
PRETRAINED_MODEL="./pretrained_models/hrnetv2_w48_imagenet_pretrained.pth"

CONFIG_FILE='configs/seg/ade20k/NLbn_fcn_ade20k_seg_hrnet.conf'
MAX_ITERS=150000
#MAX_ITERS=75000
