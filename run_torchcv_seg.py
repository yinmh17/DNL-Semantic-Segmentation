...
os.system('ls')
print('Rank {}'.format(ompi_rank()))
os.system('bash run_fs_res101_{0}_{1}_seg.sh train tag {2} {3}'.format(args.nettype, args.dataset, args.data_dir, args.restore))
os.system('bash run_fs_res101_{0}_{1}_seg.sh val tag {2} {3}'.format(args.nettype, args.dataset, args.data_dir, args.restore))
