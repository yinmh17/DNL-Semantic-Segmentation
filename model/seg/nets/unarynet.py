...
from model.seg.ops.unary_block import Unary2d
...
class UNModule(nn.Module):
    def __init__(self, in_channels, out_channels, num_classes, configer):
        ...
        self.ctb = Unary2d(inter_channels, inter_channels // 2, downsample=self.down, use_out=self.use_out, out_bn=self.out_bn)
